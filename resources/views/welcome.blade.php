...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        @foreach($users as $item)
            @if ($item->logo)
                <a class="navbar-brand logo-image" href="/"><img src="{{asset('storage') . '/'.$item->logo->name}}" alt="alternative"></a>
            @else 
                <a class="navbar-brand logo-image" href="/"><img src="{{asset('storage') . '/'. 'logoSite/default.jpeg'}}" alt="alternative"></a>  
            @endif
        @endforeach
            ...
            <div class="container"  id="Home">
                <div class="row">
                    @foreach ($users as $user)
                        ...
                        @if ($title->name === $user->headers[0]->items)
                            @foreach ($title->sections as $section)
                        @if ($section->status)
                        <div class="col-lg-6">
                            <div class="text-container">
                            <h1><span class="turquoise">{{$section->titre}}</span> {{$section->description}}</h1>
                            <p class="p-large">{{$section->contenue}}</p>
                                <a class="btn-solid-lg page-scroll" href="#1">DISCOVER</a>
                    ...
                    @foreach ($titles as $title)
                        ...
                        @if ($section->status)
                            <div class="swiper-slide">
                                    <div class="image-container">
                                    <img class="img-responsive" src="{{asset('storage') . '/' . $section->image}}" alt="alternative" width="50" height="50">
                                    </div>
                                </div>    
                        @endif
                            @endforeach
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    @foreach ($users as $user)
                    @foreach ($titles as $title)
                        @if ($title->name === $user->headers[1]->items)
                            @foreach ($title->sections as $section)
                        @if ($section->status)
                             <!-- Card -->
                            <div class="card">
                                <img class="card-image" src="{{asset('storage') . '/' . $section->image}}" alt="alternative">
                                <div class="card-body">
                                <h4 class="card-title">{{$section->titre}}</h4>
                                    <p>{{$section->contenue}}</p>
                                </div>
                            </div>
                            <!-- end of card -->
                        @endif
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                <div class="footer-col <?php if($footer->id == 2):?> 'middle' <?php elseif($footer->id == 3):?> 'last' <?php endif; ?>">
                        <h4>{{$footer->title}}</h4>
                        <p>{{$footer->content}}</p>
                    </div>
                </div> <!-- end of col -->
